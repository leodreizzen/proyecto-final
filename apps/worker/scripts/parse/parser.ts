...
import {parseResolutionStructure} from "@/parser/parser";
...
async function main() {
    ...
    const file_markdown = (await PythonShell.run('src/parser/pdfparse.py', {args: [filePath], pythonPath: ".venv/scripts/python.exe"})).join("\n"); //TODO LINUX
